 ...
 * Depends on javafx tools. If not tinkered there will be no issues. IF tinkered but conventions are
 * followed then it should be fine.
 * 
...
public class HealthBar {
    ...
    /**
     * Determine the position of the health bar at a time step. If the player is damaged, the health
     * bar moves left
     * 
